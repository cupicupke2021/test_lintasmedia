...
function erpSysIndex($aryCnt){
    ...
    function sysList($sys,$aryCnt){
		...
		$sSQL = "SELECT a.id, a.name as itm_group_name, a.parent, b.itm_code, b.name as itm_name, c.name as itm_varian, c.price  FROM $mst_itm_group a
                    LEFT JOIN $mst_itm_mat b ON a.id = b.itm_group
                    LEFT JOIN $mst_itm_mat_varian c ON b.id = c.pid
                    ORDER BY a.id, b.itm_code 
				";
